...
```{r animal.plot, fig.cap= "Number of Observations per Species by Year", echo=FALSE}
...
```{r total.species.plot, fig.cap= "Total Observations of Species 2000-2022", echo=FALSE}
...
```{r inat.spatial, fig.cap="All iNaturalist Observations 2000-2022", echo=FALSE}
...
```{r endangered.bird.map, fig.cap = "Endangered Bird Observations 2000-2022", echo=FALSE}
...
```{r threatened.bird.map, fig.cap = "Threatened Bird Observations 2000-2022", echo=FALSE}
...
```{r protected.reptiles.map, fig.cap = "Protected Reptile Observations 2000-2022", echo=FALSE}
...
```{r alligator.and.croc.map, fig.cap = "Alligator and Crocodile Observations 2000-2022", echo=FALSE}
...
```{r protected.mammal.map, fig.cap = "Protected Mammal Observations 2000-2022", echo=FALSE}
...
```{r invasive.map, fig.cap = "Invasive Species Observations 2000-2022", echo=FALSE}
