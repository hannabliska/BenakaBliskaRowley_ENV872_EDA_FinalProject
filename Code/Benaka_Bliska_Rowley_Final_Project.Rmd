...
treesSRS4.ts.decomp <- stl(treesSRS4.ts, s.window="per")
treesSRS5.ts.decomp <- stl(treesSRS5.ts, s.window="periodic")
treesSRS6.ts.decomp <- stl(treesSRS6.ts, s.window="periodic")

#plotting components
plot(treesSRS4.ts.decomp) 
plot(treesSRS5.ts.decomp) 
plot(treesSRS6.ts.decomp) 
