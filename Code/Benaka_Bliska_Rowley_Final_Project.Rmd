...
```{r mangrovemap, fig.cap = "Map of Mangrove Monitoring Sites in Florida Coastal Everglades National Park", echo=FALSE}
...
```{r mangrovesiteplot, fig.cap = "Above Ground Biomass of Mangrove Trees by Site in the Florida Coastal Everglades", echo=FALSE}
...
```{r AGBsitesplot, fig.cap = "Mean Above Ground Biomass of Mangrove Trees by Year at Sites in Florida Everglades National Park", echo=FALSE}
...
```{r animalplot, fig.cap= "Number of Observations per Species by Year", echo=FALSE}
...
```{r totalspeciesplot, fig.cap= "Total Observations of Species 2000-2022", echo=FALSE}
...
print(totalspeciesplot)
```

```{r inatspatial, fig.cap="All iNaturalist Observations 2000-2022", echo=FALSE}
...
```{r phosplot, fig.cap = "Mean total phosphorus measurements over time in the Florida Coastal Everglades", echo=FALSE}
...
```{r nitroplot, fig.cap = "Mean total nitrogen measurements over time in the Florida Coastal Everglades", echo=FALSE}
...
We were also interested in identifying areas of mangrove habitat within the Florida Coastal Everglades that may be stressed due to high nutrient concentrations. Therefore, we initially examined if different mangrove vegetation plots in the park had different phosphorus and nitrogen concentrations. Our initial visualization suggested that some sites, such as site SRS6, may have higher phosphorus concentrations ((See Figure \@ref(fig:phossiteplot)), See Figure B). Similarly, our initial visualization suggested the site SRS1d may have higher nitrogen concentrations ((See Figure \@ref(fig:nitrositeplot)), See Figure C). These visualizations motivated further analysis to determine if the concentrations at different sites were significantly different from one another.

```{r phossiteplot, fig.cap = "Total phosphorus measurements for sites in the Florida Coastal Everglades", echo=FALSE}
...
```{r mapsitephosplot, fig.cap = "Map of Florida Coastal Everglades indicating level of phosphorus measurements per site", echo=FALSE}
mapsitephosplot <- mapview(site.locations.nutrients.sf, zcol="TP", at = seq(0, 60, 10))
mapsitephosplot
```
Figure B: Map of Florida Coastal Everglades indicating level of phosphorus measurements per site

```{r nitrositeplot, fig.cap = "Total nitrogen measurements for sites in the Florida Coastal Everglades", echo=FALSE}
...
```{r mapsitenitroplot, fig.cap = "Map of Florida Coastal Everglades indicating level of nitrogen measurements per site", echo=FALSE}
mapsitenitroplot <- mapview(site.locations.nutrients.sf, zcol="TN")
mapsitenitroplot
```
Figure C: Map of Florida Coastal Everglades indicating level of nitrogen measurements per site
...
After filling in missing yearly values for each site using `na.approx`, we used the `ts` function to create time series graphs of mean above ground biomass for trees in each of the three sites (See Figures \@ref(fig:SRS5tsplot), \@ref(fig:SRS6tsplot), \@ref(fig:SRS4tsplot)). Using Mann-Kendall tests, we determined that site SRS5 had a significant decreasing trend in average above ground biomass (score = -71, p-value = 0.008015). Mangroves at site SRS6 had a *nearly* significant decreasing trend in above ground biomass (score = -51, p-value = 0.05824), while site SRS4 displayed no statistically significant trend in above ground biomass over time (score = -27, p-value = 0.32471).
...
```{r SRS4tsplot, fig.cap = "Time series of mean above ground biomass for trees in SRS4", echo=FALSE}
SRS4tsplot <- plot(treesSRS4.ts) 

```

```{r SRS5tsplot, fig.cap = "Time series of mean above ground biomass for trees in SRS5", echo=FALSE}
SRS5tsplot <- plot(treesSRS5.ts) 

```

```{r SRS6tsplot, fig.cap = "Time series of mean above ground biomass for trees in SRS6", echo=FALSE}
SRS6tsplot <- plot(treesSRS6.ts) 
...
```{r, preparing iNaturalist data for mapping, include=FALSE}
...
```{r endangeredbirdmap, fig.cap = "Endangered Bird Observations 2000-2022", echo=FALSE}
...
print(endangeredbirdmap)
```

```{r threatenedbirdmap, fig.cap = "Threatened Bird Observations 2000-2022", echo=FALSE}
...
print(threatenedbirdmap)
```

```{r protectedreptilesmap, fig.cap = "Protected Reptile Observations 2000-2022", echo=FALSE}
...
protectedreptilesmap <- mapview(inat.greenseaturtle, col.regions="mediumorchid2", layer.name= "Green Sea Turtle (Endangered) Observations 2000-2022")+
  ...
  mapview(park.utm, color = 'black', lwd = 2, col.regions = "black", alpha.regions = 0, layer.name = "Everglades National Park Boundary")
print(protectedreptilesmap)
```

```{r alligatorandcrocmap, fig.cap = "Alligator and Crocodile Observations 2000-2022", echo=FALSE}
...
alligatorandcrocmap <- mapview(inat.crocodile, col.regions="seagreen2", layer.name = "American Crocodile (Threatened) Observations 2000-2022")+
  ...
  mapview(park.utm, color = 'black', lwd = 2, col.regions = "black", alpha.regions = 0, layer.name = "Everglades National Park Boundary")
print(alligatorandcrocmap)
```

```{r protectedmammalmap, fig.cap = "Protected Mammal Observations 2000-2022", echo=FALSE}
...
mapview(inat.west.indian.manatee, col.regions="seagreen2", layer.name= "West Indian Manatee (Threatened) Observations 2000-2022")+
  mapview(park.utm, color = 'black', lwd = 2, col.regions = "black", alpha.regions = 0, layer.name = "Everglades National Park Boundary")
print(protectedmammalmap)
```

```{r invasivemap, fig.cap = "Invasive Species Observations 2000-2022", echo=FALSE}
...
```{r plotmeanmonthlyphos, fig.cap="Mean monthly phosphorus levels from 2001-2021 in the Florida Coastal Everglades", echo=FALSE}
...
```{r plotmeanmonthlynitro, fig.cap="Mean monthly nitrogen levels from 2001-2021 in the Florida Coastal Everglades", echo=FALSE}
...
```{r anovaphossiteplot, fig.cap="Phosphorus measurements for mangrove habitat sites in the Florida Coastal Everglades", echo=FALSE}
...
```{r anovanitrositeplot, fig.cap= "Nitrogen measurements for mangrove habitat sites in the Florida Coastal Everglades", echo=FALSE}
