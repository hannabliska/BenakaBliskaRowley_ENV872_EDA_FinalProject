...
```{r phos.plot, fig.cap = "Mean total phosphorus measurements over time in the Florida Coastal Everglades", echo=FALSE}
...
```{r nitro.plot, fig.cap = "Mean total nitrogen measurements over time in the Florida Coastal Everglades", echo=FALSE}
...
```{r phos.site.plot, fig.cap = "Total phosphorus measurements for sites in the Florida Coastal Everglades", echo=FALSE}
...
```{r map.site.phos.plot, fig.cap = "Map of Florida Coastal Everglades indicating level of phosphorus measurements per site", echo=FALSE}
map.site.phos.plot <- mapview(site.locations.nutrients.sf, zcol="TP", at = seq(0, 60, 10))
map.site.phos.plot
```


```{r nitro.site.plot, fig.cap = "Total nitrogen measurements for sites in the Florida Coastal Everglades", echo=FALSE}
...
```{r map.site.nitro.plot, fig.cap = "Map of Florida Coastal Everglades indicating level of nitrogen measurements per site", echo=FALSE}
...
```{r plot.mean.monthly.phos, fig.cap="Mean monthly phosphorus levels from 2001-2021 in the Florida Coastal Everglades", echo=FALSE}
...
```{r plot.mean.monthly.nitro, fig.cap="Mean monthly nitrogen levels from 2001-2021 in the Florida Coastal Everglades", echo=FALSE}
...
```{r anova.phos.site.plot, fig.cap="Phosphorus measurements for mangrove habitat sites in the Florida Coastal Everglades", echo=FALSE}
...
```{r anova.nitro.site.plot, fig.cap= "Nitrogen measurements for mangrove habitat sites in the Florida Coastal Everglades", echo=FALSE}
