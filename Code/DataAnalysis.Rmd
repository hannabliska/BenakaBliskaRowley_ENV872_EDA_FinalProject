...
anova.nitro.site.plot <- ggplot(FCE.site.nutrient.data, aes(x=SITE_NAME, y=TN)) +
  ...
  annotate("text", x = 1, y = 1500, label = "a") +
  annotate("text", x = 2, y = 1500, label = "a") +
  annotate("text", x = 3, y = 1500, label = "a") +
  annotate("text", x = 4, y = 1500, label = "ab") +
  annotate("text", x = 5, y = 1500, label = "b") +
  annotate("text", x = 6, y = 1500, label = "bc") +
  annotate("text", x = 7, y = 1500, label = "bc") +
...
anova.phos.site.plot <- ggplot(FCE.site.nutrient.data, aes(x=SITE_NAME, y=TP)) +
  ...
  annotate("text", x = 2, y = 200, label = "b") +
  annotate("text", x = 3, y = 200, label = "c") +
  annotate("text", x = 4, y = 200, label = "cd") +
  annotate("text", x = 5, y = 200, label = "cd") +
  annotate("text", x = 6, y = 200, label = "d") +
  annotate("text", x = 7, y = 200, label = "d") +
  annotate("text", x = 8, y = 200, label = "d")
