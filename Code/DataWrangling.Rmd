...
```{r, wrangling nutrients data set for mean phosphorus and nitrogen for each year}
...
```{r, wranging nutrients data for mean phosphorus and nitrogen for each month}
#phosphorus
...
colnames(Months) <- c("Date")

FCE.phos.monthly.data <- left_join(Months, FCE.phos.monthly.data, by = c("Date"))
...
FCE.nitro.monthly.data <- left_join(Months, FCE.nitro.monthly.data, by = c("Date"))
