...
ggplot(C.trees.SRS4, aes(x=DATE,y=mean.DBH))+
  ...
  labs(title="DBH for Conacarpus erectus in SRS4", y="Mean Diameter at Breast Height")
...
ggplot(L.trees.SRS4, aes(x=DATE,y=mean.DBH))+
  geom_point()+
  geom_smooth(method = "lm", se=F)+
  labs(title="DBH for Laguncularia racemosa in SRS4", y="Mean Diameter at Breast Height")
...
ggplot(R.trees.SRS4, aes(x=DATE,y=mean.DBH))+
  geom_point()+
  geom_smooth(method = "lm", se=F)+
  labs(title="DBH for Rhizophora mangle in SRS4", y="Mean Diameter at Breast Height")
