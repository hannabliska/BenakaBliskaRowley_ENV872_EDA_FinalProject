...
inat.processed <- inat.all %>% 
  ...
  filter(scientific_name=="Calidris canutus"| scientific_name=="Charadrius melodus"|scientific_name=="Mycteria americana"| scientific_name=="Rostrhamus sociabilis plumbeus"| scientific_name=="Sterna dougallii"| scientific_name== "Haliaeetus leucocephalus" | scientific_name=="Falco peregrinus"| #filtering protected birds
         
          scientific_name=="Procyon lotor"| scientific_name=="Puma concolor couguar"| scientific_name=="Trichechus manatus" |scientific_name=="Trichechus manatus latirostris" |#filtering protected mammals and raccoon
...
scientific_name == "Python bivittatus"|scientific_name== "	
Dasypus novemcinctus") %>%  #filtering for invasive species
