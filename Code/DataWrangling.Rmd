...
inat.processed <- inat.all %>% 
  ...
  filter(scientific_name=="Caldris canutus"| scientific_name=="Charadrius melodus"|scientific_name=="Mycteria americana"| scientific_name=="Rostrhamus sociabilis plumbeus"| scientific_name=="Sterna dougallii"| scientific_name== "Haliaeetus leucocephalus" | scientific_name=="Falco peregrinus"| #filtering protected birds
...
scientific_name == "Python bivittatus") #filtering for invasive species
